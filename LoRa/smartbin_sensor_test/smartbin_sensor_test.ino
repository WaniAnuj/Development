...
#define dht11_PIN 6                        // dht 11 pin connected to pin number 6
#define mq135_pin A2                       // MQ135 digital pin connected to pin number A2
#define shp_pin A3                         // Sharp sensor connected on pin number A0
const byte mediumFilterWindowSize = 1;

GSM800 gsm(4, 7); //Rx and Tx
DHT dht(6, DHT11);
...
void setup()
{
  ...
  attachInterrupt(digitalPinToInterrupt(3), pir_isr , FALLING);
