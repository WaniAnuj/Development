...
int claw_pin = 6;   // variable to assign the servo to pin 6 (Claw Motor)
int left_pin = 9;   // variable to assign the servo to pin 9 (Base Motor)
int base_pin = 10;  // variable to assign the servo to pin 10 (Right Motor)
int right_pin = 11;  // variable to assign the servo to pin 11 (Left Motor)
